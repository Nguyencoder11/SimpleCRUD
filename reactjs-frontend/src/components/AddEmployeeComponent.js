                        ...
                        <div className='card-body'>
                            <form className='' action=''>
                                ...
                                <div className='form-group mb-2'>
                                    ...
                                    <input type='email' placeholder='Enter email ID' name='emailId' className='form-control' value={emailId} onChange={(e) => setEmailId(e.target.value)}></input>
                                </div>
                                <button className='btn btn-success' onClick={(e) => saveOrUpdateEmployee(e)}>Submit</button>
                                <Link to={"/employees"} className='btn btn-danger ml-2'>Cancel</Link>
                            </form>
                        </div>
                    </div>
                </div>
